/**
 * electronBridge - Typed accessors for all window globals
 *
 * Centralizes (window as any) access behind typed functions so that
 * action classes and components import a typed wrapper instead of
 * casting window to any at every call site.
 */
